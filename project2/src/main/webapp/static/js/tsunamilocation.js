...
function renderChart(data, aggregateBy) {
    ...
    d3.json("/earthquake-viz/static/data/world-50m.json", function(error, world) {
    ...
    d3.select(".chart")
        ...
        .enter()
        .append('circle')
        .attr("class", function(d) { return getMapPointFillClass(d["Magnitude"]); })
        .attr("r", 3)
    ...
    legend
        ...
        .enter()
        .append('rect')
        .attr('class', function(d) { return getMapPointFillClass(d) })
